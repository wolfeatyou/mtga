...
**Служебный скан пака (механика, не рассуждение):** прочитать пак целиком, отметить топ в цвете, топ вне цвета и карты с `⚠trap` — чтобы ничего не пропустить физически.
