...
| 3 | **Существо к T2 — сверять с популяцией, а не с 60%** (медиана победителей **54.3%**, мин 36.4%; жёсткий ≥60% СНЯТ 10.08 — `rules_graveyard` §1–2) | ref_decks/ n=23; наши лучшие 70–77% = топ-3 популяции; вылет 11.07 — 40% |
