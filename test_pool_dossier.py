...
check("земля:U/W" in text and "⚠НЕ-ДАЁТ-ЦВЕТОВ-ПАРЫ" in text,
      "Lake-town показывает цвета (U/W) и флаг «не даёт цветов пары» в BG (§ 8.22: "
      "тапленную W/U-землю играли оба opus-агента, поймал sonnet/high-судья по тексту)")
